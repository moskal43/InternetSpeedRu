...
Гарантированный baseline версии `v0.1.1`:
...
`v0.1.1`. Версии Home Assistant Core ниже 2026.8 не поддерживаются.
...
`v0.1.1` baseline is Home Assistant OS with Home Assistant Core 2026.8+; Container,
...
и ruff. `mypy` не является release gate `v0.1.1`.
